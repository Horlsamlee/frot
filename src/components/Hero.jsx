...
//style={{background: "linear-gradient(180deg, #186784 6.53%, rgba(229, 239, 255, 0.40) 37.5%, rgba(229, 239, 255, 0.26) 99.99%)"}}
const Hero = () => {
  return (
    <section className="flex flex-col justify-center xl:h-screen m-auto text-black font-sans" >
      <div className="container max-w-[1440px] px-4 sm:px-6 flex lg:flex-row flex-col justify-between gap-4 items-center mx-auto">
        <div className='py-24'>
        <h1 className="text-4xl xl:text-7xl lg:text-6xl font-bold font-lora"><span>Your Gateway to</span><span className='text-primary'> Radiological Excellence</span></h1>
    ...
    return (
        <div className='flex items-center text-primary'>
          ...
          <div>
            ...
            <p className='font-sans text-base font-semibold text-black'>Patients Connected</p>
          </div>
          <div>
            <CountUp end={500} duration={5} />+
            <p className='font-sans text-base font-semibold text-black'>Radiologists Available</p>
          </div>
          <div>
            <CountUp end={100} duration={5} />+
            <p className='font-sans text-base font-semibold text-black'>Hospitals Linked</p>
          </div>
        </div>
        </div>
      );
