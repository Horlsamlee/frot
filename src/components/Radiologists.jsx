  ...
  return (
    ...
    <div className="container max-w-[1200px] py-12  px-4 sm:px-6 flex justify-between gap-4 items-center mx-auto">
           <div className='flex flex-col space-y-4'>
              <h1 className='font-lora text-4xl font-bold text-center'>Our <span className='text-primary'>Radiologists</span></h1>
              <p className='text-lg text-center'>At AMORAD, we understand the critical role that radiologists play in healthcare. With the increasing demand for radiology services and the integration of AI technology, our platform empowers radiologists to excel in their field.</p>
